...
const SHELL = [
  ...
  'js/backup.js', 'js/recorder.js', 'js/sync.js', 'js/milestones.js',
  'js/views/clients.js', 'js/views/session.js', 'js/views/plan.js', 'js/views/recap.js',
  'js/views/week.js', 'js/views/drills.js', 'js/views/settings.js', 'js/views/help.js',
  'GUIDE.md',
];
